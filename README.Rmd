...
This basic example shows how to download ctd index from the BBMP program in the year 2022 and download, read and plot the first item in the index using the `oce` package.
